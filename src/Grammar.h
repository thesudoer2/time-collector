...
public:
        ...
        : TimeGrammar::base_type(_expression)
    {
        ...
        _parentheses_interval = ('(' >> _time >> '-' >> _time >> ')')[boost::spirit::qi::_val = boost::phoenix::construct<TimeCollector::TimeInterval>(boost::spirit::qi::_1, boost::spirit::qi::_2)];

        // Simple interval without parentheses (start - end)
        _simple_interval = (_time >> '-' >> _time)[boost::spirit::qi::_val = boost::phoenix::construct<TimeCollector::TimeInterval>(boost::spirit::qi::_1, boost::spirit::qi::_2)];

        // Expression can be a series of intervals with + or just space separated
        _expression = ((_parentheses_interval | _simple_interval) % (-boost::spirit::qi::lit('+') | +boost::spirit::qi::space))[boost::spirit::qi::_val = boost::phoenix::construct<TimeCollector::TimeExpression>(boost::spirit::qi::_1)];
    }
